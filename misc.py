...
#    sel = VarianceThreshold() # remove all features with variance < threshold
    sel.fit(train_data, labels)
    train_data1 = sel.transform(train_data)
#    test_data = sel.transform(test_data)

    sel2 = SelectKBest(f_classif, k = 20)
    train_data2 = sel2.fit_transform(train_data1, labels) # 10% increase in some embedding techniques
...
#    return train_data1, train_data2, sel, sel2
    return train_data2, sel, sel2
